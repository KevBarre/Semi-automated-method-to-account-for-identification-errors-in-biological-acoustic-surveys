# This script allows to select a subset of the data at each maximum error risk tolerance using
# the corresponding confidence indexes calculated previoulsy (script 1_ErrorRiskModelling.R) 
# for each species.
#############################################################################################
...
# per row assigned to a species with a confidence index of the identification
...
# Vector creation of different thresholds of the maximum error risk tolerance 
...
## according to each threshold of maximum error risk tolerance (i.e. needed confidence indexes) 
## for each species
