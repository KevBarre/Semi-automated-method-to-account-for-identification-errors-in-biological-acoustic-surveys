...
# different maximum error rate tolerances. When results are consistent between thresholds 
...
# variables for each maximum error risk tolerance in the automatic identification
tab = c()
